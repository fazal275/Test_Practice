...
public class Final {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        // enter IncidentDescription
         ...
         // capturing IncidentID from the pop up
         //WebElement IncidentID = driver.findElement(By.xpath("//input[@id='jbarmessage']"));
         //WebElement IncidentID = driver.findElement(By.xpath("//html/body/div[1]/span[@class='jbar-content']"));
         // WebElement IncidentID = driver.findElement(By.xpath("//html/body/div/span[@class='jbar-content']"));
