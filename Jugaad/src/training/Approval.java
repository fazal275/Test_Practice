...
public class Approval {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        // IS head log in
              ...
              driver.findElement(By.xpath("//input[@id='gs_REQUEST_ID']")).sendKeys("2976");
              Thread.sleep(2000);
              ...
              //provide approval
		      WebElement approval= driver.findElement(By.xpath("//select[@id='workFlowStatusId']/option[@value='4']"));
		      approval.click();
...
//---------------------------------------------------------------------------------------------------//		
 ...
 //Raise defects in Additional Testing Stage
	    ...
	    //insert user name
	   Uname7.sendKeys("829593");  
	   
	   // find user name
	   WebElement password8 = driver.findElement(By.id("password"));
	   
	   // insert password
	   password8.sendKeys("test");
	  ...
	  driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
	   ...
	   //Raised Defect Against (L2/L3) 
	     driver.findElement(By.xpath("//input[@id='getreqdata']")).sendKeys("2976");	     
	     Thread.sleep(2000);
	  ...
	  Thread.sleep(2000);
	   ...
	   //select defect id
		 ...
		 //Comments
		  ...
		  //select project id 
		    driver.findElement(By.xpath("//input[@id='gs_REQUEST_ID']")).sendKeys("2975");
		     Thread.sleep(1000);
		     driver.findElement(By.xpath("//td[1]/a/img")).click();
		     Thread.sleep(1000);
  ...
  driver.findElement(By.xpath("//input[@id='gs_REQUEST_ID']")).sendKeys("2973");
  Thread.sleep(2000);
  driver.findElement(By.xpath("//td[1]/a/img")).click();
...
//verify that the “Milestone button” is displayed and enabled
  ...
  if (MilestoneIconEnabled1==false)
  {
      ...
      // Reason for delay: 	
         ...
         wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//div[3]//button[1]")))).click();;
...
//verify that the “Milestone button” is displayed and enabled
  ...
  wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//div[3]/div[3]/div[1]/button[1]")))).click();
...
Thread.sleep(2000);
   ...
   Thread.sleep(2000);
     ...
     driver.findElement(By.xpath("//input[@id='gs_REQUEST_ID']")).sendKeys("2974");
     Thread.sleep(2000);
     driver.findElement(By.xpath("//td[1]/a/img")).click();
   
     //change status from Ready To Deploy to Production Relaesed
     Thread.sleep(3000);
